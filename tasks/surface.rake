...
namespace :api do
  desc "Verify the compile-surface test references every inherent pub fn and exported macro"
  task :surface do
    ...
    puts "[api:surface] #{report.total} inherent pub fns and macros all referenced"
  end
end
