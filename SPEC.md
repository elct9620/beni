...
| A typed array, hash, or string mutated through a frozen receiver, an instance-variable assignment to a frozen receiver or one that cannot hold instance variables, a class-variable assignment to a frozen receiver, or a constant assignment to a frozen receiver or one that is not a class or module | surfaced as a Rust `Err`, never unwinds across FFI |
