//! A consumer's Ruby surface, built for both macOS architectures.
//!
//! Small on purpose — the scenario is about whether one archive can
//! carry an extension for both slices, not about the breadth of the
//! API. That breadth is `beni-tests`.
